...
Google Draydream 또한 비슷하게 작동할것입니다.  
...
* VR 지원 수준 결정
  ...
  * 6DOF + 6DOF input
  ...
  당신이 할 수 있는 최선에 대한 다른 입력이 없기 때문에

  다음 레벨에는 하나의 3DOF 입력 장치가 있습니다. 일반적으로
  사물을 가리킬 수 있고 사용자는 적어도 2개의 버튼을 가지고 있습니다. Daydream
