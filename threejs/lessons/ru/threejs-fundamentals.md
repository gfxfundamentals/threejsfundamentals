...
краткий список вещей, которые вы, как ожидается, уже знаете](prerequisites.html). 
...
[как работают сцены, в следующей статье](scenegraph.html).
...
к различным ситуациям](responsive.html).
