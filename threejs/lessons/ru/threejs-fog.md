...
[lil-gui](https://github.com/georgealways/lil-gui). lil-gui принимает объект и свойство и автоматически создает интерфейс для этого типа свойства.
...
Итак, давайте добавим еще одно *виртуальное* свойство в наш помощник, который будет устанавливать оба цвета, когда lil-gui манипулирует им. 
