...
Вот пример из [статьи об отзывчивости](responsive.html)
...
[визуализировать текстуру, используя цель визуализации](rendertargets.html).
...
Мы применили настройки выше к примеру из [статьи об отзывчивости](responsive.html).
